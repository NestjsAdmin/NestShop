...
一个基于NestAdmin框架开发的连锁商城系统，采用Nunapp+Vue3+Nest.js技术栈、全新的UI设计、支持集群部署。后台管理系统包含平台管理，店铺管理、商品管理、订单管理、规格管理、权限管理、资源管理等模块。


## 前言

本商城致力于为连锁型企业打造一个功能完整、易于维护的连锁商城系统，采用主流微服务技术实现。目前已有多位合伙商投入正式使用，并为其提供技术支持。
## 文档
