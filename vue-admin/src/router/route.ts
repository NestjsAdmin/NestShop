...
export const dynamicRoutes: Array<RouteRecordRaw> = [
	{
		...
		children: [
			...
			},
			{
				...
				children: [
					...
					},
					{
						path: '/commodity/cate',
						name: 'cate',
						component: () => import('/@/views/commodity/cate/index.vue'),
						meta: {
							title: '分类管理',
							isLink: '',
							isHide: false,
					...
					},
					{
						...
						name: 'label',
						component: () => import('/@/views/commodity/label/index.vue'),
						meta: {
							title: '标签管理',
							isLink: '',
							isHide: false,
			...
			},
			{
				...
				children: [
					...
					},
					{
						path: '/store/order',
						name: 'order',
						component: () => import('/@/views/store/order/index.vue'),
						meta: {
							title: '订单管理',
							isLink: '',
							isHide: false,
			...
			},
			{
				path: '/client',
				name: 'client',
				component: () => import('/@/views/client/swiper/index.vue'),
				redirect: '/client/swiper',
				meta: {
					title: '客户端管理',
					isLink: '',
					isHide: false,
				...
				children: [
					...
					{
						path: '/client/clientUser',
						name: 'clientUser',
						component: () => import('/@/views/client/clientUser/index.vue'),
						meta: {
							title: '商城用户管理',
							isLink: '',
							isHide: false,
