...
const initLineChart = () => {
	...
	const option = {
		...
		grid: { top: 70, right: 20, bottom: 30, left: 80 },
		tooltip: { trigger: 'axis' },
		legend: { data: ['开销', '销售额'], right: 0 },
		xAxis: {
		...
		series: [
			{
				...
				symbol: 'circle',
				smooth: true,
				data: [43983235, 31387542, 47342343, 40234232, 61239565, 62123435, 39434656, 40324575, 34686736, 60845632, 50353256, 65345645],
			...
			},
			{
				...
				symbol: 'circle',
				smooth: true,
				data: [49858985, 32094853, 64382321, 45234286, 70458435, 63213213, 54232316, 45396074, 59434244, 66450643, 69346884, 80245656],
...
const initPieChart = () => {
	...
	var getname = ['水产品', '水果蔬菜', '大豆粮油', '厨房用品', '鲜花绿植'];
